...
//         var_dump($insert_id);
        ...
        if($insert_id){
            ...
            //设置附件
            $this->_attachment_related($insert_id,$content['attachments']);
...
//             redirect('admin/posts/manage');
    ...
    public function _apply_slug($pid){
...
//         var_dump($this->metas_mdl->metas['category']);
    ...
    public function _set_tags($pid,$tags,$before_count=true,$after_count=true){
    ...
    public function _attachment_related($pid,$attachments=array()){
    ...
    public function _send_trackback($pid,$trackbacks = array())
    {
        if(empty($pid))
        {
            return;
        ...
        foreach ($trackbacks as $trackback)
        {
            ...
            {
                log_message('error', $this->trackback->display_error());
            }
        }                       
    } 
